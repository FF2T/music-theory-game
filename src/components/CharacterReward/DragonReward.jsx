...
export default function DragonReward({ level = 0 }) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 select-none">
      ...
      <p className="text-xs text-center font-medium" style={{
        color: l >= 50 ? '#fbbf24' : l >= 30 ? '#34d399' : '#9ca3af',
      }}>
        {l === 0 && 'Réponds correctement pour faire apparaître le dragon !'}
        {l >= 1  && l < 6  && 'Un corps écailleux se forme...'}
        {l >= 6  && l < 11 && 'Une tête adorable apparaît !'}
        {l >= 11 && l < 16 && 'Il se dresse sur ses pattes !'}
        {l >= 16 && l < 21 && 'Une queue avec un bout en coeur !'}
        {l >= 21 && l < 26 && 'Des petites cornes et des oreilles !'}
        {l >= 26 && l < 31 && 'De grands yeux dorés et curieux !'}
        {l >= 31 && l < 36 && 'De belles écailles émeraude !'}
